...
export class ResultsService {
  ...
  public exportAsExcel(data: any[]) {
    ...
    const excelBase64: any = XLSX.write(workbook, { bookType: 'xlsx', type: 'base64' });
    let excelBuffer = new Buffer(excelBase64, 'base64');
    this.saveAsExcelFile(excelBuffer, 'generated.xlsx');
